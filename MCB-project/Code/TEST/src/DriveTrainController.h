...
namespace ThornBots {
    ...
    public:
        ...
        void setMotorValues(bool sendMotorTimeout, bool useWASD, bool doBeyblading, double right_stick_vert, double right_stick_horz, std::string input);
    ...
    private:
        ...
        int getMotorOneSpeedWithCont(bool doBeyblading, double right_stick_vert, double right_stick_horz);
        int getMotorTwoSpeedWithCont(bool doBeyblading, double right_stick_vert, double right_stick_horz);
        int getMotorThreeSpeedWithCont(bool doBeyblading, double right_stick_vert, double right_stick_horz);
        int getMotorFourSpeedWithCont(bool doBeyblading, double right_stick_vert, double right_stick_horz);
